...
export const LOCATIONS = [
  ...
  },
  {
    ...
    book: 'b_liumai',
    boss: { title: '大輪明王的執念', enemies: ['b_jiumozhi', 'e_seng', 'e_seng', 'e_gaoshou'], scale: 1.1, flee: true },
    mobs: ['e_seng', 'e_gaoshou'],
  ...
  },
  {
    ...
    links: ['yangzhou'],
    book: 'b_jiuyin',
    boss: { title: '瘋癲的西毒', enemies: ['b_ouyangfeng', 'e_gaoshou', 'e_gaoshou', 'e_gaoshou'], scale: 1.18, flee: true },
    mobs: ['e_gaoshou'],
  ...
  },
  {
    ...
    links: ['huashan'],
    requireBooks: 14,
    boss: { title: '華山論劍', enemies: ['b_dongfang', 'e_weishi', 'e_weishi'], scale: 1.06, flee: false },
